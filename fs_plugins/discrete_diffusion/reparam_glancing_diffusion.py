...
class ReparamGlancingDiffusion(DiscreteDiffusion):
    def __init__(
            self, 
            num_timesteps,
            mask_id, 
    ...
    def q_sample_coupled(self, x_0, x_T, t1, t2, non_special_sym_mask):
        ...
        x_T1, x_T2 = x_T.chunk(2, dim=0)

        x_t1[mask_t1] = x_T1[mask_t1]
        mask_t1 = x_t1 != x_0
        x_0_ignore_t1[torch.bitwise_not(mask_t1)] = -1

        x_t2[mask_t2] = x_T2[mask_t2]
        mask_t2 = x_t2 != x_0
    ...
    def q_sample(self, x_0, x_T, t, non_special_sym_mask):
        # samples q(x_t | x_0)
    ...
    def sample_step(self, decoder_out, denoising_fn, **kwargs):
        ...
        if decoding_strategy.startswith("reparam"):
            ...
            # where to unmask
            changes = torch.rand(output_tokens.shape, device=output_tokens.devnice) < unmask_prob
