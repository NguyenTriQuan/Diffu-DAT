...
class NATDAGLoss(FairseqCriterion):
    ...
    def _compute_ngram_loss(self, probs, transition, tgt_tokens, name="loss", factor=1.0):
        ...
        ngrams_order = self.max_ngram_order
        ...
        with torch.no_grad():
            ...
            ngrams_tensor_bsz = torch.LongTensor(ngrams_list_bsz).cuda(tgt_tokens.device) #bsz, number of ngram, length of ngram
