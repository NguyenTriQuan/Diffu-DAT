...
class IterativeRefinementGenerator(object):
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        for step in range(self.max_iter + 1):
            ...
            print(terminated.device, sent_idxs.device, decoder_out.output_tokens.device, decoder_out.output_scores)
            sent_idxs = sent_idxs.to(terminated.device)
            decoder_out.output_scores = decoder_out.output_scores.to(terminated.device)
